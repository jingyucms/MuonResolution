...
def compareMassRes(trackType):
	...
	file2016BB = open("Boosteddefault/MassResolutionVsPt_%s_BB.pkl"%trackType)
	file2016BE = open("Boosteddefault/MassResolutionVsPt_%s_BE.pkl"%trackType)
	file2017BB = open("Boostedcruijff/MassResolutionVsPt_%s_BB.pkl"%trackType)
	file2017BE = open("Boostedcruijff/MassResolutionVsPt_%s_BE.pkl"%trackType)
	...
	canv.Print("chi2CompareVsPt2017_%s_BB.pdf"%trackType)
	...
	canv.Print("chi2CompareVsPt2017_%s_BE.pdf"%trackType)
