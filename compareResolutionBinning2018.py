...
def compareMassRes(trackType):
	...
	fileORBB = open("Rebin22018/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileNoBB = open("Rebin82018/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileDefaultBE = open("default2018/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileORBE = open("Rebin22018/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileNoBE = open("Rebin82018/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionVsMassBinning2018_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionVsMassBinning2018_%s_BE.pdf"%trackType)
