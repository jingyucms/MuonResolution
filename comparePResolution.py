...
def comparePtRes(trackType):
	...
	plotPad.DrawFrame(0,0,3100,xMax,";p [GeV]; p resolution [%]")
	...
	canv.Print("PResolutionCompare_%s_B.pdf"%trackType)
	...
	leg = TLegend(0.52, 0.76, 0.95, 0.91,"%s Overlap"%trackType,"brNDC")
	leg.SetFillColor(10)
	leg.SetFillStyle(0)
	leg.SetLineColor(10)
	leg.SetShadowColor(0)
	...
	canv.Print("PResolutionCompare_%s_O.pdf"%trackType)
	...
	leg = TLegend(0.52, 0.76, 0.95, 0.91,"%s Endcap"%trackType,"brNDC")
	leg.SetFillColor(10)
	leg.SetFillStyle(0)
	leg.SetLineColor(10)
	leg.SetShadowColor(0)
	...
	canv.Print("PResolutionCompare_%s_E.pdf"%trackType)
