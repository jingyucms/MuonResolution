...
def compareMassRes(trackType):
	...
	fileORBB = open("2018BoostedWindowLarge/MassResolutionVsPt_%s_BB.pkl"%trackType)
	fileNoBB = open("2018BoostedWindowSmall/MassResolutionVsPt_%s_BB.pkl"%trackType)
	fileDefaultBE = open("2018Boosteddefault/MassResolutionVsPt_%s_BE.pkl"%trackType)
	fileORBE = open("2018BoostedWindowLarge/MassResolutionVsPt_%s_BE.pkl"%trackType)
	fileNoBE = open("2018BoostedWindowSmall/MassResolutionVsPt_%s_BE.pkl"%trackType)
