...
def compareMassRes(trackType):
	...
	file2016BB = open("Rebin2/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2016BE = open("Rebin2/MassResolutionVsMass_%s_BE.pkl"%trackType)
	file2017BB = open("Rebin2Cruijff/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2017BE = open("Rebin2Cruijff/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileCBB = open("Rebin2Crystal/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileCBE = open("Rebin2Crystal/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionCompareFuncRebin2_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionCompareFuncRebin2_%s_BE.pdf"%trackType)
