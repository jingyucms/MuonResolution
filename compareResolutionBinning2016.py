...
def compareMassRes(trackType):
	...
	fileDefaultBB = open("default2016/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileORBB = open("Rebin22016/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileNoBB = open("Rebin82016/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileDefaultBE = open("default2016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileORBE = open("Rebin22016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileNoBE = open("Rebin82016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	plotPad.DrawFrame(0,0,6000,xMax,";mass [GeV]; mass resolution")
	...
	leg.SetBorderSize(1)		
	leg.AddEntry(graphDefaultBB,"default binning","l")
	leg.AddEntry(graphORBB,"finer binning","l")
	leg.AddEntry(graphNoBB,"coarser Binning","l")
	...
	ratioPad.DrawFrame(0,0.8,6000,1.2,";;ratio")

	ratioORBB.Draw("samepe")
	ratioNoBB.Draw("samepe")

	canv.Print("massResolutionVsMassBinning2016_%s_BB.pdf"%trackType)
	...
	leg.SetShadowColor(0)
	leg.SetBorderSize(1)		
	leg.AddEntry(graphDefaultBE,"default Binning","l")
	leg.AddEntry(graphORBE,"finer Binning","l")
	leg.AddEntry(graphNoBE,"coarser Binning","l")
	...
	canv.Print("massResolutionVsMassBinning2016_%s_BE.pdf"%trackType)
