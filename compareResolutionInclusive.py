...
def compareMassRes(trackType):
	...
	file2016BB = open("plots2016Inclusive/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2016BE = open("plots2016Inclusive/MassResolutionVsMass_%s_BE.pkl"%trackType)
	file2017BB = open("plots2017Inclusive/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2017BE = open("plots2017Inclusive/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionCompareInclusive_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionCompareInclusive_%s_BE.pdf"%trackType)
