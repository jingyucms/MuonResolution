...
def compareMassRes(trackType):
	...
	fileORBB = open("WindowSmall2016/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileNoBB = open("WindowLarge2016/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileDefaultBE = open("default2016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileORBE = open("WindowSmall2016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileNoBE = open("WindowLarge2016/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionVsMassWindow2016_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionVsMassWindow2016_%s_BE.pdf"%trackType)
