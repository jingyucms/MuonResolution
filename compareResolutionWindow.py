...
def compareMassRes(trackType):
	...
	fileORBB = open("WindowSmall/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileNoBB = open("WindowLarge/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileDefaultBE = open("default/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileORBE = open("WindowSmall/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileNoBE = open("WindowLarge/MassResolutionVsMass_%s_BE.pkl"%trackType)
