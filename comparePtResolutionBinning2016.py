...
def compareMassRes(trackType):
	...
	fileORBB = open("2016BoostedRebin2/MassResolutionVsPt_%s_BB.pkl"%trackType)
	fileNoBB = open("2016BoostedRebin4/MassResolutionVsPt_%s_BB.pkl"%trackType)
	fileDefaultBE = open("2016Boosteddefault/MassResolutionVsPt_%s_BE.pkl"%trackType)
	fileORBE = open("2016BoostedRebin2/MassResolutionVsPt_%s_BE.pkl"%trackType)
	fileNoBE = open("2016BoostedRebin4/MassResolutionVsPt_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionVsPtBinning2016_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionVsPtBinning2016_%s_BE.pdf"%trackType)
