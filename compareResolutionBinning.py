...
def compareMassRes(trackType):
	...
	fileDefaultBB = open("default/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileORBB = open("Rebin2/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileNoBB = open("Rebin8/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileDefaultBE = open("default/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileORBE = open("Rebin2/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileNoBE = open("Rebin8/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionVsMassBinning_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionVsMassBinning_%s_BE.pdf"%trackType)
