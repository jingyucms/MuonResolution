...
def compareMassRes(trackType):
	...
	for c in cat:
		...
		fileORBB = open("WindowSmallPSplit/PResolutionVsP_%s_%s.pkl"%(trackType,c))
		fileNoBB = open("WindowLargePSplit/PResolutionVsP_%s_%s.pkl"%(trackType,c))
		...
		ratioPad.DrawFrame(0,0.9,3100,1.1,";;ratio")

		ratioORBB.Draw("samepe")
		ratioNoBB.Draw("samepe")

		canv.Print("pResolutionWindow_%s_%s.pdf"%(trackType,c))
