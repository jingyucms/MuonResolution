...
def compareMassRes(trackType):
	...
	file2016BB = open("WindowSmall/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2016BE = open("WindowSmall/MassResolutionVsMass_%s_BE.pkl"%trackType)
	file2017BB = open("WindowSmallCruijff/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2017BE = open("WindowSmallCruijff/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileCBB = open("WindowSmallCrystal/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileCBE = open("WindowSmallCrystal/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionCompareFuncSmall_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionCompareFuncSmall_%s_BE.pdf"%trackType)
