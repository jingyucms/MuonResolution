...
def compareMassRes(trackType):
	...
	file2016BB = open("Rebin8/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2016BE = open("Rebin8/MassResolutionVsMass_%s_BE.pkl"%trackType)
	file2017BB = open("Rebin8Cruijff/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2017BE = open("Rebin8Cruijff/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileCBB = open("Rebin8Crystal/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileCBE = open("Rebin8Crystal/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionCompareFuncRebin8_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionCompareFuncRebin8_%s_BE.pdf"%trackType)
