...
def compareMassRes(trackType):
	...
	file2016BB = open("WindowLarge/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2016BE = open("WindowLarge/MassResolutionVsMass_%s_BE.pkl"%trackType)
	file2017BB = open("WindowLargeCruijff/MassResolutionVsMass_%s_BB.pkl"%trackType)
	file2017BE = open("WindowLargeCruijff/MassResolutionVsMass_%s_BE.pkl"%trackType)
	fileCBB = open("WindowLargeCrystal/MassResolutionVsMass_%s_BB.pkl"%trackType)
	fileCBE = open("WindowLargeCrystal/MassResolutionVsMass_%s_BE.pkl"%trackType)
	...
	canv.Print("massResolutionCompareFuncLarge_%s_BB.pdf"%trackType)
	...
	canv.Print("massResolutionCompareFuncLarge_%s_BE.pdf"%trackType)
